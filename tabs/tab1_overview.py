...
with c1:
    ...
    st.plotly_chart(style_fig(fig, title="Crash Share by Mode"), width="stretch")
...
with c2:
    ...
    st.plotly_chart(style_fig(fig, title="Annual Crash Trend by Mode"), width="stretch")
...
with c3:
    ...
    st.plotly_chart(style_fig(fig, title="Seasonal Pattern by Month"), width="stretch")
...
with c4:
    ...
    st.plotly_chart(style_fig(fig, title="Crashes by Hour of Day"), width="stretch")
